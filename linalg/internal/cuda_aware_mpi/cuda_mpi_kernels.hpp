...
namespace internal
{
    struct cuda_mpi
    {
        ...
        static void MatrixMultiplyMultiVectorsAndRedistribute(cublasHandle_t cublas_handle,
                                            MatrixType& blockMatrix, 
                                            InputMultiVectorType& input_multiVector, 
                                            typename ResultMultiVectorType<MatrixType, InputMultiVectorType>::type& result_multiVector,
...
#include "linalg/internal/cuda_aware_mpi/quasi_hermitian_lanczos.hpp"
#include "linalg/internal/cuda_aware_mpi/cholqr.hpp"
#include "linalg/internal/cuda_aware_mpi/rayleighRitz.hpp"
#include "linalg/internal/cuda_aware_mpi/quasi_hermitian_rayleighRitz.hpp"

...
namespace internal
{
    ...
    */
    ...
    void cuda_mpi::lanczos_dispatch(cublasHandle_t cublas_handle,
                 std::size_t M,
                 std::size_t numvec,
                 MatrixType& H,
                 ...
                 chase::Base<typename MatrixType::value_type> *ritzV)
    {
        ...
        {
                cuda_mpi::pseudo_hermitian_lanczos(cublas_handle, M, numvec, H, V, upperb, ritzv, Tau, ritzV);
        }
        else
        {
                cuda_mpi::lanczos(cublas_handle, M, numvec, H, V, upperb, ritzv, Tau, ritzV);
        }
    }

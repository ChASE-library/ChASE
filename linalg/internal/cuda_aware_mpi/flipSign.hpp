...
{    
    template<typename T>
    void cuda_mpi::flipLowerHalfMatrixSign(chase::distMatrix::BlockBlockMatrix<T, chase::platform::GPU>& H)
    {
        chase::linalg::internal::cuda::chase_flipMatrixSign(H.l_data() + H.l_half(), H.l_rows() - H.l_half(), H.l_cols(), H.l_ld(), (cudaStream_t)0); 
    }
    
    template<typename T>
    void cuda_mpi::flipLowerHalfMatrixSign(chase::distMatrix::BlockCyclicMatrix<T, chase::platform::GPU>& H)
    {
        chase::linalg::internal::cuda::chase_flipMatrixSign(H.l_data() + H.l_half(), H.l_rows() - H.l_half(), H.l_cols(), H.l_ld(), (cudaStream_t)0); 
    }

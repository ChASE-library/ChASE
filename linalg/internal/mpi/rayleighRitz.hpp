 ...
 *
 * This function dispatches to the correct Rayleigh-Ritz procedure based on the
 * matrix type
 *
...
void cpu_mpi::rayleighRitz_dispatch(
                                       ...
                                       chase::platform::CPU>* A)
{
    ...
    {
        cpu_mpi::pseudo_hermitian_rayleighRitz_v2(H, V1, V2, W1, W2, ritzv,
                                                  offset, subSize, A);
    }
    else
    {
                                       ...
                                       chase::platform::CPU>* A)
{
    ...
    chase::linalg::blaspp::t_gemm(
        ...
        subSize, &One, V2.l_data() + offset * V2.l_ld(), V2.l_ld(), A->l_data(),
        subSize, &Zero, V1.l_data() + offset * V1.l_ld(), V1.l_ld());
}
} // namespace internal
} // namespace linalg
} // namespace chase

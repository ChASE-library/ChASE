...
template <typename T>
void readMatrix(T* H, std::string path_in, std::string spin, CHASE_INT kpoint,
...
int main(int argc, char* argv[]) {
  ...
  desc.add_options()("help,h", "show this message")(
      ...
      "nev", po::value<CHASE_INT>(&nev)->required(),
      "Wanted Number of Eigenpairs")(
      "nex", po::value<CHASE_INT>(&nex)->default_value(25),
      "Extra Search Dimensions")("deg",
                                 po::value<CHASE_INT>(&deg)->default_value(20),
                                 "Initial filtering degree")(
      "bgn", po::value<CHASE_INT>(&bgn)->default_value(2), "Start ell")(
      "end", po::value<CHASE_INT>(&end)->default_value(2), "End ell")(
      "spin", po::value<std::string>(&spin)->default_value("d"), "spin")(
      "kpoint", po::value<CHASE_INT>(&kpoint)->default_value(0), "kpoint")(

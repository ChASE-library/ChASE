...
namespace mpi
{
    ...
    * @brief Template function to get the MPI data type corresponding to a C++ type.
    * 
    ...
    */
    ...
    /**
    * @ingroup mpi_type_mappings
    * @brief Specialization for `std::complex<float>` to return the corresponding MPI data type.
    * 
    ...
    */
    ...
    /**
    * @ingroup mpi_type_mappings
    * @brief Specialization for `std::complex<double>` to return the corresponding MPI data type.
    * 
    * @return `MPI_DOUBLE_COMPLEX` corresponding to the `std::complex<double>` type.
    */
    template <>

...
TYPED_TEST(flipSignCPUTest, flipLowerSignCorrectness) {
    ...
    chase::linalg::internal::cpu::flipLowerHalfMatrixSign(H.rows(),H.cols(),H.data(),H.ld());
...
TYPED_TEST(flipSignCPUTest, flipRightSignCorrectness) {
    ...
    chase::linalg::internal::cpu::flipRightHalfMatrixSign(H.rows(),H.cols(),H.data(),H.ld());

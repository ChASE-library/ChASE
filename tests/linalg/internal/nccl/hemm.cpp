...
TYPED_TEST(HEMMCPUDistTest, HEMMDistCorrectnessCUDAAwareGPU) {
    ...
    auto H_ = chase::distMatrix::BlockBlockMatrix<T, chase::platform::GPU>(N, N, mpi_grid);
    ...
    auto W_ = chase::distMultiVector::DistMultiVector1D<T, chase::distMultiVector::CommunicatorType::row, chase::platform::GPU>(N, n, mpi_grid);    
    ...
    chase::linalg::internal::nccl::BlockBlockMultiplyMultiVectors(this->cublasH_, &alpha, H_, V_, &beta, W_, offset, subSize);
    W_.D2H();
    ...
    chase::linalg::internal::nccl::BlockBlockMultiplyMultiVectors(this->cublasH_, &alpha, H_, W_, &beta, V_, offset, subSize);
...
TYPED_TEST(HEMMCPUDistTest, HEMMRedistribeAsyncDistCorrectness) {
    ...
    auto V_ = chase::distMultiVector::DistMultiVector1D<T, chase::distMultiVector::CommunicatorType::column, chase::platform::GPU>(N, n, mpi_grid);
    auto W_ = chase::distMultiVector::DistMultiVector1D<T, chase::distMultiVector::CommunicatorType::row, chase::platform::GPU>(N, n, mpi_grid);
    auto V2_ = chase::distMultiVector::DistMultiVector1D<T, chase::distMultiVector::CommunicatorType::column, chase::platform::GPU>(N, n, mpi_grid);
    ...
    chase::linalg::internal::nccl::BlockBlockMultiplyMultiVectorsAndRedistributeAsync(this->cublasH_, H_, V_, W_, V2_, W2_, offset, subSize);
    ...
    W2_.H2D();
    chase::linalg::internal::nccl::BlockBlockMultiplyMultiVectorsAndRedistributeAsync(this->cublasH_, H_, W_, V_, W2_, V2_, offset, subSize);

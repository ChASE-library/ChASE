...
TYPED_TEST(HEMMGPUDistTest, HEMMDistCorrectnessCUDAAwareGPU) {
    ...
    chase::linalg::internal::cuda_nccl::MatrixMultiplyMultiVectors(this->get_cublas_handle(), &alpha, H_, V_, &beta, W_, offset, subSize);
    W_.D2H();
    ...
    chase::linalg::internal::cuda_nccl::MatrixMultiplyMultiVectors(this->get_cublas_handle(), &alpha, H_, W_, &beta, V_, offset, subSize);
...
TYPED_TEST(HEMMGPUDistTest, HEMMRedistribeAsyncDistCorrectness) {
    ...
    chase::linalg::internal::cuda_nccl::MatrixMultiplyMultiVectorsAndRedistributeAsync(this->get_cublas_handle(), H_, V_, W_, V2_, W2_, offset, subSize);
    ...
    W2_.H2D();
    chase::linalg::internal::cuda_nccl::MatrixMultiplyMultiVectorsAndRedistributeAsync(this->get_cublas_handle(), H_, W_, V_, W2_, V2_, offset, subSize);

...
TYPED_TEST(HEMMCPUDistTest, HEMMDistCorrectness) {
    ...
    chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectors(&alpha, H_, W_, &beta, V_, offset, subSize);
...
TYPED_TEST(HEMMCPUDistTest, HEMMDistThrow) 
{
    ...
    T alpha = T(1.0);
    T beta = T(2.0);
    EXPECT_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectors(&alpha, H_, W_, &beta, V_);}, std::runtime_error);
    EXPECT_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectors(&alpha, H_, V_, &beta, W_);}, std::runtime_error);
    ...
    EXPECT_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectors(&alpha, H2_, W2_, &beta, V2_, 100, 2);}, std::invalid_argument);
    EXPECT_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectors(&alpha, H2_, W2_, &beta, V2_, 0, 0);}, std::invalid_argument);
    EXPECT_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectors(&alpha, H2_, W2_, &beta, V2_, 0, 100);}, std::invalid_argument);
    EXPECT_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectors(&alpha, H2_, W2_, &beta, V2_, 0, 5);}, std::invalid_argument);
    EXPECT_NO_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectors(&alpha, H2_, W2_, &beta, V2_, 0, 4);});
}
...
TYPED_TEST(HEMMCPUDistTest, HEMMRedistribeAsyncDistCorrectness) {
    ...
    chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectorsAndRedistributeAsync(H_, V_, W_, V2_, W2_, offset, subSize);
    ...
    chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectorsAndRedistributeAsync(H_, W_, V_, W2_, V2_, offset, subSize);
...
TYPED_TEST(HEMMCPUDistTest, DistThrow) 
{
    ...
    T alpha = T(1.0);
    T beta = T(2.0);
    EXPECT_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectorsAndRedistributeAsync(H_, W_, V_, W2_, V2_);}, std::runtime_error);
    EXPECT_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectorsAndRedistributeAsync(H_, V_, W_, V2_, W2_);}, std::runtime_error);
    ...
    EXPECT_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectorsAndRedistributeAsync(H3_, W3_, V3_, W4_, V4_, 100, 2);}, std::invalid_argument);
    EXPECT_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectorsAndRedistributeAsync(H3_, W3_, V3_, W4_, V4_, 0, 0);}, std::invalid_argument);
    EXPECT_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectorsAndRedistributeAsync(H3_, W3_, V3_, W4_, V4_, 0, 100);}, std::invalid_argument);
    EXPECT_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectorsAndRedistributeAsync(H3_, W3_, V3_, W4_, V4_, 0, 5);}, std::invalid_argument);
    EXPECT_NO_THROW({chase::linalg::internal::mpi::BlockBlockMultiplyMultiVectorsAndRedistributeAsync(H3_, W3_, V3_, W4_, V4_, 0, 4);});
}
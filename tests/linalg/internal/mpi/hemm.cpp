...
TYPED_TEST(HEMMCPUDistTest, HEMMDistCorrectness)
{
    ...
    chase::linalg::internal::cpu_mpi::MatrixMultiplyMultiVectors(
        &alpha, H_, V_, &beta, W_, offset, subSize);
    ...
    chase::linalg::internal::cpu_mpi::MatrixMultiplyMultiVectors(
        &alpha, H_, W_, &beta, V_, offset, subSize);
...
TYPED_TEST(HEMMCPUDistTest, HEMMDistThrow)
{
    ...
    auto V_ = chase::distMultiVector::DistMultiVector1D<
        T, chase::distMultiVector::CommunicatorType::column>(16, 4, mpi_grid);
    auto W_ = chase::distMultiVector::DistMultiVector1D<
        T, chase::distMultiVector::CommunicatorType::row>(12, 4, mpi_grid);
    ...
    auto V2_ = chase::distMultiVector::DistMultiVector1D<
        T, chase::distMultiVector::CommunicatorType::column>(10, 4, mpi_grid);
    auto W2_ = chase::distMultiVector::DistMultiVector1D<
        T, chase::distMultiVector::CommunicatorType::row>(10, 4, mpi_grid);

    EXPECT_THROW(
        {
            chase::linalg::internal::cpu_mpi::MatrixMultiplyMultiVectors(
                &alpha, H2_, W2_, &beta, V2_, 100, 2);
        },
        std::invalid_argument);
    EXPECT_THROW(
        {
            chase::linalg::internal::cpu_mpi::MatrixMultiplyMultiVectors(
                &alpha, H2_, W2_, &beta, V2_, 0, 0);
        },
        std::invalid_argument);
    EXPECT_THROW(
        {
            chase::linalg::internal::cpu_mpi::MatrixMultiplyMultiVectors(
                &alpha, H2_, W2_, &beta, V2_, 0, 100);
        },
        std::invalid_argument);
    EXPECT_THROW(
        {
            chase::linalg::internal::cpu_mpi::MatrixMultiplyMultiVectors(
                &alpha, H2_, W2_, &beta, V2_, 0, 5);
        },
        std::invalid_argument);
    EXPECT_NO_THROW({
        chase::linalg::internal::cpu_mpi::MatrixMultiplyMultiVectors(
            &alpha, H2_, W2_, &beta, V2_, 0, 4);
    });
}
...
TYPED_TEST(HEMMCPUDistTest, HEMMRedistribeAsyncDistCorrectness)
{
    ...
    chase::linalg::internal::cpu_mpi::
        MatrixMultiplyMultiVectorsAndRedistributeAsync(H_, V_, W_, V2_, W2_,
                                                       offset, subSize);
    ...
    chase::linalg::internal::cpu_mpi::
        MatrixMultiplyMultiVectorsAndRedistributeAsync(H_, W_, V_, W2_, V2_,
                                                       offset, subSize);
...
TYPED_TEST(HEMMCPUDistTest, DistThrow)
{
    ...
    EXPECT_THROW(
        {
            chase::linalg::internal::cpu_mpi::
                MatrixMultiplyMultiVectorsAndRedistributeAsync(H_, W_, V_, W2_,
                                                               V2_);
        },
        std::runtime_error);
    EXPECT_THROW(
        {
            chase::linalg::internal::cpu_mpi::
                MatrixMultiplyMultiVectorsAndRedistributeAsync(H_, V_, W_, V2_,
                                                               W2_);
        },
        std::runtime_error);

    auto H3_ = chase::distMatrix::BlockBlockMatrix<T>(10, 10, mpi_grid);
    auto V3_ = chase::distMultiVector::DistMultiVector1D<
        T, chase::distMultiVector::CommunicatorType::column>(10, 4, mpi_grid);
    auto W3_ = chase::distMultiVector::DistMultiVector1D<
        T, chase::distMultiVector::CommunicatorType::row>(10, 4, mpi_grid);
    auto V4_ = chase::distMultiVector::DistMultiVector1D<
        T, chase::distMultiVector::CommunicatorType::column>(10, 4, mpi_grid);
    auto W4_ = chase::distMultiVector::DistMultiVector1D<
        T, chase::distMultiVector::CommunicatorType::row>(10, 4, mpi_grid);
    ...
    EXPECT_THROW(
        {
            chase::linalg::internal::cpu_mpi::
                MatrixMultiplyMultiVectorsAndRedistributeAsync(
                    H3_, W3_, V3_, W4_, V4_, 100, 2);
        },
        std::invalid_argument);
    EXPECT_THROW(
        {
            chase::linalg::internal::cpu_mpi::
                MatrixMultiplyMultiVectorsAndRedistributeAsync(H3_, W3_, V3_,
                                                               W4_, V4_, 0, 0);
        },
        std::invalid_argument);
    EXPECT_THROW(
    ...
    EXPECT_NO_THROW({
        chase::linalg::internal::cpu_mpi::
            MatrixMultiplyMultiVectorsAndRedistributeAsync(H3_, W3_, V3_, W4_,
                                                           V4_, 0, 4);
    });
}
...
TYPED_TEST(HEMMCPUDistTest, HEMMDistCorrectnessBlockCyclic)
{
    ...
    auto H_ = chase::distMatrix::BlockCyclicMatrix<T>(N, N, block_size,
                                                      block_size, mpi_grid);
    auto V_ = chase::distMultiVector::DistMultiVectorBlockCyclic1D<
        T, chase::distMultiVector::CommunicatorType::column>(N, n, block_size,
                                                             mpi_grid);
    auto W_ = chase::distMultiVector::DistMultiVectorBlockCyclic1D<
        T, chase::distMultiVector::CommunicatorType::row>(N, n, block_size,
                                                          mpi_grid);

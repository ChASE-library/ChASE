...
protected:
    void SetUp() override
    {
        ...
        H = new chase::matrix::PseudoHermitianMatrix<T, chase::platform::GPU>(
            N, N);
        H->allocate_cpu_data();
        ...
        H_tiny =
            new chase::matrix::PseudoHermitianMatrix<T, chase::platform::GPU>(
                N_tiny, N_tiny);
...
TYPED_TEST(PseudoHermitianLanczosGPUTest, tinyPseudoHermitianSimplefiedLanczos)
{
    ...
    chase::matrix::Matrix<T, chase::platform::GPU> Vec(
        this->N_tiny, this->M_tiny, this->N_tiny, this->V_tiny.data());

    chase::linalg::internal::cuda::lanczos(this->cublasH_, this->M_tiny,
                                           this->H_tiny, Vec, &upperb);
...
TYPED_TEST(PseudoHermitianLanczosGPUTest, tinyPseudoHermitianLanczos)
{
    ...
    chase::linalg::internal::cuda::lanczos(
        this->cublasH_, this->M_tiny, this->numvec_tiny, this->H_tiny, Vec,
...
TYPED_TEST(PseudoHermitianLanczosGPUTest, PseudoHermitianSimplefiedLanczos)
{
    ...
    chase::matrix::Matrix<T, chase::platform::GPU> Vec(this->N, this->M,
                                                       this->N, this->V.data());

    chase::linalg::internal::cuda::lanczos(this->cublasH_, this->M, this->H,
                                           Vec, &upperb);
...
TYPED_TEST(PseudoHermitianLanczosGPUTest, PseudoHermitianLanczos)
{
    ...
    chase::linalg::internal::cuda::lanczos(
        this->cublasH_, this->M, this->numvec, this->H, Vec, &upperb,

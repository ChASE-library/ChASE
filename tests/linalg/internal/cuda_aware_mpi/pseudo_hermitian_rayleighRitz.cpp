...
TYPED_TEST(PseudoRayleighRitzGPUDistTest, TinyPseudoHermitianRRDistGPUCorrectness) {
    ...
    chase::linalg::internal::cuda_mpi::pseudo_hermitian_rayleighRitz(this->get_cublas_handle(), 

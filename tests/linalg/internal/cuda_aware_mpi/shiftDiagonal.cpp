...
template <typename T>
class shiftDiagonalGPUCUDAAwareMPI : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TYPED_TEST_SUITE(shiftDiagonalGPUCUDAAwareMPI, TestTypes);

TYPED_TEST(shiftDiagonalGPUCUDAAwareMPI, ShiftDistCorrectnessGPU)
{
    ...
    chase::linalg::internal::cuda_mpi::shiftDiagonal(

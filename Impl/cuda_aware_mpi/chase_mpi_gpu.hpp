 ...
 * This class implements the GPU-based parallel version of the Chase algorithm using CUDA-aware MPI
 * for efficient multi-GPU communication. The class inherits 
 ...
 * The constructor for `ChaseMPIGPU` initializes essential components, including the Hamiltonian matrix, 
...
/**
* @brief GPU-based parallel Chase algorithm with CUDA-Aware MPI.
* 
* This class provides an implementation of the Chase algorithm for solving eigenvalue 
* problems on GPU-based platforms. 
...
class ChaseMPIGPU : public ChaseBase<typename MatrixType::value_type>
{
...
public:
    /**
     * @brief Constructs the `ChaseMPIGPU` object.
     * 
    ...
    ChaseMPIGPU(const ChaseMPIGPU&) = delete;
    ...
    bool checkSymmetryEasy() override
    {
        ...
        is_sym_ = chase::linalg::internal::cuda_aware_mpi::checkSymmetryEasy(cublasH_, *Hmat_);  
        return is_sym_;
    }
    ...
    void symOrHermMatrix(char uplo) override
    {
        ...
        chase::linalg::internal::cuda_aware_mpi::symOrHermMatrix(uplo, *Hmat_);   
    }
    ...
    {   
        ...
        chase::linalg::internal::cuda_aware_mpi::lanczos(cublasH_,
                                              m, 
                                              *Hmat_, 
                                              *V1_, 
                                              upperb);   
    ...
    void Shift(T c, bool isunshift = false) override 
    {
        ...
        chase::linalg::internal::cuda_aware_mpi::shiftDiagonal(*Hmat_, d_diag_xoffs, d_diag_yoffs, diag_cnt, std::real(c));       
    }
    ...
    void HEMM(std::size_t block, T alpha, T beta, std::size_t offset) override 
    {

        {
            if (next_ == NextOp::bAc)
            {
                chase::linalg::internal::cuda_aware_mpi::MatrixMultiplyMultiVectors(cublasH_,
                                                                            &alpha, 
                                                                            *Hmat_, 
                                                                            *V1_, 
                                                                            &beta, 
    ...
    void QR(std::size_t fixednev, chase::Base<T> cond) override 
    {
        ...
        {
#ifdef HAS_SCALAPACK
            chase::linalg::internal::cuda_aware_mpi::houseHoulderQR(*V1_);
#else
        ...
        {
            info = chase::linalg::internal::cuda_aware_mpi::modifiedGramSchmidtCholQR(cublasH_,
                                                            cusolverH_,
                                                            V1_->l_rows(), 
                                                            V1_->l_cols(), 
                                                            locked_,
            ...
            if(info != 0)
            {
                ...
                info = chase::linalg::internal::cuda_aware_mpi::shiftedcholQR2(cublasH_,
                                                                cusolverH_,
                                                                V1_->g_rows(),
                                                                V1_->l_rows(), 
                                                                V1_->l_cols(), 
        ...
        }else
        {
            ...
            {
                info = chase::linalg::internal::cuda_aware_mpi::cholQR1(cublasH_,
                                                                cusolverH_,
                                                                V1_->l_rows(), 
                                                                V1_->l_cols(), 
                                                                V1_->l_data(),  
            ...
            {                
                info = chase::linalg::internal::cuda_aware_mpi::cholQR2(cublasH_,
                                                                cusolverH_,
                                                                V1_->l_rows(), 
                                                                V1_->l_cols(), 
                                                                V1_->l_data(),  
    ...
    void RR(chase::Base<T>* ritzv, std::size_t block) override 
    {
        ...
        chase::linalg::internal::cuda_aware_mpi::rayleighRitz(cublasH_,
                                                   cusolverH_,
                                                   *Hmat_, 
                                                   *V1_, 
                                                   *V2_, 
    ...
    {
        SCOPED_NVTX_RANGE();        
        chase::linalg::internal::cuda_aware_mpi::residuals(cublasH_,
                                                *Hmat_,
                                                *V1_,
                                                *V2_,
                                                *W1_,

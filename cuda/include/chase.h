...
void chase(
  MKL_Complex16* H, int N, MKL_Complex16* V, MKL_Complex16* W,
...
void ColSwap( cuDoubleComplex *V, int N, int i, int j,
              cublasHandle_t *handle, cuDoubleComplex *ztmp );

int calc_degrees(
  int N, int unconverged, int nex,  double upperb, double lowerb,
  double tol, double *ritzv, double *resid, int *degrees,
  cuDoubleComplex *V, cuDoubleComplex *W, cuDoubleComplex *ztmp,
  cublasHandle_t *handle );

int locking(
  int N, int unconverged, double tol,
...
void QR(
  int N, int nevex, int converged, cuDoubleComplex *dW,
  cuDoubleComplex *tau, cuDoubleComplex *saveW,
  cublasHandle_t *handle, cuDoubleComplex* zmem_d );

void RR(
  int N, int block, double *Lambda,

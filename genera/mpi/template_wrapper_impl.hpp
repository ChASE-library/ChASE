...
template <>
void t_gemm<std::complex<float> >(const CBLAS_LAYOUT Layout,
...
// Overload of ?copy functions
template <>
void t_copy(const std::size_t n, double* x, const std::size_t incx,
    double* y, const std::size_t incy)
{
    cblas_dcopy(n, x, incx, y, incy);
}
template <>
void t_copy(const std::size_t n, float* x, const std::size_t incx,
    float* y, const std::size_t incy)
{
    cblas_scopy(n, x, incx, y, incy);
}
template <>
void t_copy(const std::size_t n, std::complex<double>* x,
    const std::size_t incx, std::complex<double>* y,
    const std::size_t incy)
{
    cblas_zcopy(n, x, incx, y, incy);
}
template <>
void t_copy(const std::size_t n, std::complex<float>* x, const std::size_t incx,
    std::complex<float>* y, const std::size_t incy)
{

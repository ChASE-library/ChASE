...
public:
    ...
    */
    ...
    void initRndVecsFromFile(std::string rnd_file) override
    {
        ...
        infile.read(reinterpret_cast<char*>(V1_),
    ...
    */
    ...
    /*!
      - For ChaseMpiDLABlaslapackSeqInplace, `lange` is implemented using
      `LAPACK` routine `xLANGE`.
      - **Parallelism is SUPPORT within node if multi-threading is actived**
      - For the meaning of this function, please visit ChaseMpiDLAInterface.
    */
    ...
    */
    ...
    /*!
      - For ChaseMpiDLABlaslapackSeqInplace, `gemm` is implemented using `BLAS`
      routine `xGEMM`.
      - **Parallelism is SUPPORT within node if multi-threading is actived**
      - For the meaning of this function, please visit ChaseMpiDLAInterface.
    */
    ...
    /*!
     - For ChaseMpiDLABlaslapackSeqInplace, `stemr` with scalar being real and
     double precision, is implemented using `LAPACK` routine `DSTEMR`.
     - **Parallelism is SUPPORT within node if multi-threading is actived**
     - For the meaning of this function, please visit ChaseMpiDLAInterface.
    */
    ...
    /*!
     - For ChaseMpiDLABlaslapackSeqInplace, `stemr` with scalar being real and
     single precision, is implemented using `LAPACK` routine `SSTEMR`.
     - **Parallelism is SUPPORT within node if multi-threading is actived**
     - For the meaning of this function, please visit ChaseMpiDLAInterface.
    */
    std::size_t stemr(int matrix_layout, char jobz, char range, std::size_t n,
    ...
    */
              ...
              std::size_t unconverged) override
    {
        ...
        {
            beta = T(-ritzv[i]);
            axpy(N_, &beta, (V1_ + locked * N_) + N_ * i, 1,
